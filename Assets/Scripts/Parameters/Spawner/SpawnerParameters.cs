...
public class SpawnerParameters : ScriptableObject
{
    ...
    [Header("The maximum value of the objects on the wave.")]
    [SerializeField][Min(0)] private int _maxCountObjects;
    [Header("The minimum value of the objects on the wave.")]
    ...
    [Header("The starting value of the time between waves of objects.")]
    [SerializeField][Min(0)] private float _maxReloadingTime;
    [Header("Minimum value of the time between waves of objects.")]
